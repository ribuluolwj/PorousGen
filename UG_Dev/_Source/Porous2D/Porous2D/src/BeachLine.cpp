...
#include "../include/Voronoi/Point2.h"
#include "../include/Voronoi/BeachLine.h"
...
treeNode<BeachSection>* VoronoiDiagramGenerator::addBeachSection(Site* site) {
	...
	if (lSection && lSection == rSection) {
		...
		VoronoiEdge* newEdge = diagram->createEdge(lSection->data.site, newSection->data.site, nullptr, nullptr);
